...
Remove the discount from purchase subscriptions.
Change the date for upcoming orders (working).
time spend-: (7hr)
https://admin.shopify.com/store/deepk-store/apps/subscription-app-238/app