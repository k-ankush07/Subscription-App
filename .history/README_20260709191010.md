...
Today Report:-
Add shipping, remove the product, update the quantity through the API after the first-order checkout to add this X number of orders ,
and add extra data to the metafields.
Working on auto-generated orders.
Time spend : (7hr)
