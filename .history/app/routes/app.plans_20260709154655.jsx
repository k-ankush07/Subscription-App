...
export const loader = async ({ request }) => {
            ...
            sellingPlans(first: 10) {
              edges {
                node {
                  ...
                  # 👇 ye naya field — humara stored extra_settings metafield
  ...
  // Har sellingPlan ke andar extraSettingsMetafield.value ek JSON STRING hai —
  // usko wapas object me parse karke plan node ke andar merge kar dete hain,
  // taaki frontend ko seedha usable object mile (parsing frontend me na karni pade).
