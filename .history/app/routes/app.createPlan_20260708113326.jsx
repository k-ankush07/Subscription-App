...
export const action = async ({ request }) => {
  ...
  const shopifySellingPlanIds =
   ...
   const fullConfigToStore = {
     shippingDiscount: payload.giveShippingDiscount
    ? {
        enabled: payload.giveShippingDiscount,
        type: payload.shippingDiscount.type ?? "PERCENTAGE",
        value: Number(payload.shippingDiscount.value) || 0,
      }
    : null,
