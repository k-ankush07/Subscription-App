...
async function processShopBillingCycles(admin, shop) {
  ...
  // Widened window (yesterday -> tomorrow) instead of a strict calendar-day
  // window. Brand-new contracts with short (e.g. daily) intervals can have
  // a cycle boundary that falls just outside a same-day window, which
  // Shopify reports as "Billing cycle start date out of range."
