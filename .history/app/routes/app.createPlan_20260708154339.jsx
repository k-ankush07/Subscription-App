...
export const action = async ({ request }) => {
  ...
  // add meta filed 
  const extraSettings = {
    shippingDiscount: payload.shippingDiscount ?? null, // e.g. { type: "PERCENTAGE" | "FIXED_AMOUNT", value: number }
    allowRemoveProduct: payload.allowRemoveProduct ?? false,
    allowQuantityChange: payload.allowQuantityChange ?? false,
    automation: payload.automation ?? null, // e.g. { pauseAfterFailedPayments, autoCancelAfterCycles, ... }
  };
