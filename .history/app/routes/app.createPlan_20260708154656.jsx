...
export const action = async ({ request }) => {
  ...
  // add meta filed 
  const extraSettings = {
    shippingDiscountBoolean: payload.giveShippingDiscount ?? null,
    shippingDiscountValue: payload.shippingDiscountValue ?? null,
    shippingDiscountAfterOrders: payload.shippingAfterOrders ?? null,
    shippingDiscountAfterOrders: payload.shippingDiscountType ?? null,
    allowRemoveProduct: payload.allowRemoveProduct ?? false,
    allowQuantityChange: payload.allowQuantityChange ?? false,
    automation: payload.automation ?? null, 
    customerSetting: payload.customerProductChanges ?? null
  };
