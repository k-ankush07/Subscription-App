...
export const action = async ({ request }) => {
  ...
  const shopifySellingPlanIds =
   ...
   const fullConfigToStore = {
     shipping: {
    giveShippingDiscount: !!payload.giveShippingDiscount,
    shippingDiscountValue: Number(payload.shippingDiscountValue) || 0,
    shippingAfterOrders: Number(payload.shippingAfterOrders) || 0,
  ...
  console.log("metafiled",metafieldSetData)
