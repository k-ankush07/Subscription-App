...
// Renders the details of a single "willApply" action based on its type
function renderActionDetails(a) {
  switch (a.type) {
    ...
    default: {
      // Fallback for any other/unknown action types
  ...
  return (
    <s-page heading="Subscription Details">
      ...
      >
        ...
        <p>
          {typeof preview.nextOrder.willApply === "string"
            ? preview.nextOrder.willApply
            : willApply.length === 0
