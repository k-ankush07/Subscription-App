...
export const action = async ({ request }) => {
  ...
  try {
    // TODO: yahan actual per-order subscription logic aayega —
    // e.g. selling plan ke `extra_settings` metafield padhna aur
    // shipping discount / free product removal / quantity change apply karna.
    console.log(
