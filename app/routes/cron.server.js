...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/15 * * * *", async () => {
    ...
    console.log("process.env https://bye-graduated-reason-qualities.trycloudflare.com")
    try {
      const res = await fetch(`https://bye-graduated-reason-qualities.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
