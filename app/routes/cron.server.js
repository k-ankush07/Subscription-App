...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://oclc-vaccine-secretariat-sunday.trycloudflare.com")
    try {
      const res = await fetch(`https://oclc-vaccine-secretariat-sunday.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
