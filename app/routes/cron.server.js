...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://powered-ian-describe-yen.trycloudflare.com")
    try {
      const res = await fetch(`https://powered-ian-describe-yen.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
