...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/15 * * * *", async () => {
    ...
    console.log("process.env https://worldcat-variety-federation-layout.trycloudflare.com")
    try {
      const res = await fetch(`https://worldcat-variety-federation-layout.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
