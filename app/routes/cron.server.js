...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://sufficient-biological-subject-referral.trycloudflare.com")
    try {
      const res = await fetch(`https://sufficient-biological-subject-referral.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
