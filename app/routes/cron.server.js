...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://avi-satisfaction-college-casino.trycloudflare.com")
    try {
      const res = await fetch(`https://avi-satisfaction-college-casino.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
