...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/15 * * * *", async () => {
    ...
    console.log("process.env https://therapeutic-warned-innovation-jonathan.trycloudflare.com")
    try {
      const res = await fetch(`https://therapeutic-warned-innovation-jonathan.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
