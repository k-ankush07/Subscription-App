...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://law-thomson-xml-russell.trycloudflare.com")
    try {
      const res = await fetch(`https://law-thomson-xml-russell.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
