...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://luther-outputs-reynolds-communist.trycloudflare.com")
    try {
      const res = await fetch(`https://luther-outputs-reynolds-communist.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
