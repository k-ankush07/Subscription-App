...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://trades-app-programmer-rick.trycloudflare.com")
    try {
      const res = await fetch(`https://trades-app-programmer-rick.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
