...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://nevada-sleeping-roommate-triple.trycloudflare.com")
    try {
      const res = await fetch(`https://nevada-sleeping-roommate-triple.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
