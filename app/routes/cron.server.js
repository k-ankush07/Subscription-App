...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://stewart-capabilities-indicator-thumb.trycloudflare.com")
    try {
      const res = await fetch(`https://stewart-capabilities-indicator-thumb.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
