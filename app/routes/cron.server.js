...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://wagner-throughout-investigate-tones.trycloudflare.com")
    try {
      const res = await fetch(`https://wagner-throughout-investigate-tones.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
