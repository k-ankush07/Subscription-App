...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://patrol-miscellaneous-tunes-gnu.trycloudflare.com")
    try {
      const res = await fetch(`https://patrol-miscellaneous-tunes-gnu.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
