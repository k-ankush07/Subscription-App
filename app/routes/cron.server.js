...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://neither-alone-bubble-powerful.trycloudflare.com")
    try {
      const res = await fetch(`https://neither-alone-bubble-powerful.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
