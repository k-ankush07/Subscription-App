...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * /15", async () => {
    ...
    console.log("process.env https://radical-carnival-llp-hypothetical.trycloudflare.com")
    try {
      const res = await fetch(`https://radical-carnival-llp-hypothetical.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
