...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://republicans-samples-designation-although.trycloudflare.com")
    try {
      const res = await fetch(`https://republicans-samples-designation-although.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
