...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://species-chamber-impression-cognitive.trycloudflare.com")
    try {
      const res = await fetch(`https://species-chamber-impression-cognitive.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
