...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://everyday-portion-attendance-varies.trycloudflare.com")
    try {
      const res = await fetch(`https://everyday-portion-attendance-varies.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
