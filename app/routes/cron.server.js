...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://weight-warranty-relations-around.trycloudflare.com")
    try {
      const res = await fetch(`https://weight-warranty-relations-around.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
