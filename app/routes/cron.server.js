...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/15 * * * *", async () => {
    ...
    console.log("process.env https://window-verse-tar-built.trycloudflare.com")
    try {
      const res = await fetch(`https://window-verse-tar-built.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
