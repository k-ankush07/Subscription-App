...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://dee-spotlight-guided-percent.trycloudflare.com")
    try {
      const res = await fetch(`https://dee-spotlight-guided-percent.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
