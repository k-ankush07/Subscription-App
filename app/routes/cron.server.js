...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://figure-commerce-depth-advertiser.trycloudflare.com")
    try {
      const res = await fetch(`https://figure-commerce-depth-advertiser.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
