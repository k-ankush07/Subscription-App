...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/15 * * * *", async () => {
    ...
    console.log("process.env https://passes-future-preservation-workplace.trycloudflare.com")
    try {
      const res = await fetch(`https://passes-future-preservation-workplace.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
