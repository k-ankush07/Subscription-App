...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://vampire-radios-provide-sql.trycloudflare.com")
    try {
      const res = await fetch(`https://vampire-radios-provide-sql.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
