...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://council-operate-planes-flower.trycloudflare.com")
    try {
      const res = await fetch(`https://council-operate-planes-flower.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
