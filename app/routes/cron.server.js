...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://stream-departments-basement-tire.trycloudflare.com")
    try {
      const res = await fetch(`https://stream-departments-basement-tire.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
