...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * /15", async () => {
    ...
    console.log("process.env https://most-premiere-holidays-rounds.trycloudflare.com")
    try {
      const res = await fetch(`https://most-premiere-holidays-rounds.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
