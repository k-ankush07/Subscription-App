...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/15 * * * *", async () => {
    ...
    console.log("process.env https://jeffrey-lined-swing-dive.trycloudflare.com")
    try {
      const res = await fetch(`https://jeffrey-lined-swing-dive.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
