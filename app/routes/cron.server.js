...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/15 * * * *", async () => {
    ...
    console.log("process.env https://proud-accessed-hey-internship.trycloudflare.com")
    try {
      const res = await fetch(`https://proud-accessed-hey-internship.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
