...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://deemed-creates-time-tuesday.trycloudflare.com")
    try {
      const res = await fetch(`https://deemed-creates-time-tuesday.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
