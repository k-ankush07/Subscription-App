...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://acts-kentucky-restaurants-exercise.trycloudflare.com")
    try {
      const res = await fetch(`https://acts-kentucky-restaurants-exercise.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
