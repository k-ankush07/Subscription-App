...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://mainstream-marcus-gotta-app.trycloudflare.com")
    try {
      const res = await fetch(`https://mainstream-marcus-gotta-app.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
