...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/15 * * * *", async () => {
    ...
    console.log("process.env https://prepaid-cindy-weed-saturn.trycloudflare.com")
    try {
      const res = await fetch(`https://prepaid-cindy-weed-saturn.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
