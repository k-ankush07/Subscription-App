...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://computed-conservative-scoring-xhtml.trycloudflare.com")
    try {
      const res = await fetch(`https://computed-conservative-scoring-xhtml.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
