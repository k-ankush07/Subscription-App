...
export function startBillingCycleCron() {
  ...
  cron.schedule("*/5 * * * *", async () => {
    ...
    console.log("process.env https://cas-feof-assured-tension.trycloudflare.com")
    try {
      const res = await fetch(`https://cas-feof-assured-tension.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
