...
export function startBillingCycleCron() {
  ...
  cron.schedule("* * * * *", async () => {
    ...
    console.log("process.env https://billy-pushed-settings-berkeley.trycloudflare.com")
    try {
      const res = await fetch(`https://billy-pushed-settings-berkeley.trycloudflare.com/api/process-billing-cycles`, {
        method: "POST",
