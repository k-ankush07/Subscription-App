...
//               value={plan.billingType}
//               onChange={(value) => {
//                 // Agar PREPAID select ho raha hai, toh defaults bhi set kar sakte ho
//                 const updates = { billingType: value };

//                 // Example: prepaid chuna to default billingFrequency = 3
//                 if (value === "PREPAID" && !plan.billingFrequency) {
//                   updates.billingFrequency = 3;
//                 }

//                 updatePlan(index, updates);
//               }}
//             /> */}
...
//                   onChange={(val) => {
//                     let num = Number(val);
//                     if (plan.discountType === "PERCENTAGE" && num > 100)
//                       num = 100;
//                     updatePlan(index, { discountValue: num });
//                   }}
//                 />
//                 <Select
//                   label="Discount type"
...
//                         )
//                           num = 100;
//                         updatePlan(index, { afterDiscountValue: num });
//                       }}
//                     />
//                     <TextField
...
//                   min={0}
//                   max={
//                     plan.shippingDiscountType === "PERCENTAGE" ? 100 : undefined
//                   }
//                   value={String(plan.shippingDiscountValue)}
//                   helpText="This will be the new delivery price"
//                   onChange={(val) => {
//                     let num = Number(val);
//                     if (plan.shippingDiscountType === "PERCENTAGE" && num > 100)
//                       num = 100;
//                     updatePlan(index, { shippingDiscountValue: num });
//                   }}
//                 />
//                 <TextField
//                   label="After # of orders"
